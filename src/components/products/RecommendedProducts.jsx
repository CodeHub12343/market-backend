...
import { useProductRecommendations, useTrackRecommendationClick } from '@/hooks/useRecommendations';
...
export default function RecommendedProducts({ productId, limit = 6 }) {
  ...
  const handleProductClick = (recommendationId) => {
    // Track the click for analytics
    if (recommendationId) {
      trackClick.mutate(recommendationId);
    }
  };
  ...
  // Extract product from recommendation or use directly
  ...
  return (
    <Section>
      <Header>
        <Title>Recommended For You</Title>
        <ViewAllButton href={`/products?recommendations=true`}>
          View All
